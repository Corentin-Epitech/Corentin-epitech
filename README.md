...
## Projet scolaire actuel : 

### Persona : 
Persona est un agrégateur d’actualités basé sur l’IA, personnalisable et sans interface graphique. Vous interagissez avec lui via un chatbot, qui vous demandera ou déduira vos identifiants, votre adresse email, vos centres d’intérêt, puis construira une newsletter personnalisée envoyée selon une fréquence
adaptable.
...
### RPG dungeon crawler :
Projet personnel d'un dungeon crawler réalisé sous godot. En phase de planifications et de game design. 
...
En dehors du dev vous avez de forte chance de me retrouver : 

- Raid sur Final Fantasy XIV (Le MMO acclamé par la critiquer et maintenant gratuit jusqu'au lvl 80 !)
- Découvrir un JRPG rétro inconnu au bataillon
...
Image de profil réalisé par les très talentueuse : 
